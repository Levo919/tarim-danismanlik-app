...
try:
    ...
    # Streamlit Secrets yapınızın doğru olduğunu görüyoruz. (image_8e2a40.png)
...
# DÜZELTME: Google Search aracını doğru ve en sade formatta tanımlıyoruz.
# Hata giderimi için sadece 'google_search' aracı adını kullanıyoruz.
...
# Uygulama ayarları (Wide mode'u ayarladığınızı görüyoruz - image_8e21e4.png)
...
if st.session_state.current_step in [1, 2, 3]:
    if st.session_state.current_step == 1:
        ...
        # SyntaxError: unterminated string literal hatası (image_991ac7.png) burada düzeltildi.
        gecmis = st.text_area("Son 3 yılda tarlanızda hangi ürünleri ektiniz?", key="gecmis_input_1", value=st.session_state.input_data
